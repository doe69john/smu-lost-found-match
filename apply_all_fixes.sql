-- This file applies all the fixes needed for automatic matching

-- 1. Fix the matching service invocation function with correct API key
...
-- 2. Add automatic matching trigger for found items
...
DO $$
BEGIN
  RAISE NOTICE 'All matching triggers have been successfully configured!';
  RAISE NOTICE '- Lost items will trigger matching when created';
  RAISE NOTICE '- Found items will trigger re-matching of relevant lost items when created';
END $$;
