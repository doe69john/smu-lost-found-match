  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight mb-2">Lost Items</h1>
          <p className="text-muted-foreground">Browse items reported as lost by the SMU community</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-muted-foreground">
            No lost items found. Try adjusting your search.
          </div>
        ) : (
